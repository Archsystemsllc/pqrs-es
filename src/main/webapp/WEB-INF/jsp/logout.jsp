			...
			<div class="login_header blue_lgel">
				<ul class="login_branding">
					<li>
						...
						<div>
							<img
								src="${pageContext.request.contextPath}/resources/images/logo_zing.png"
								width="130" height="50" alt="zing">
						</div>
						<%-- <span>IPMS Login</span>--%>

						<h2>Zing Logged Out</h2>
						<h2>You can log back in</h2> <c:if test="${not empty error}">
...
<div class="block_container blue_d">
				...
				<a href="${pageContext.request.contextPath}/app/dashboard"><input class="login_btn blue_lgel" name="" value="Login"
							type="button">
						</a>
			</div>
			</div>
