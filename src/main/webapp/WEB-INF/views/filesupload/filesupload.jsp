...
$(document).ready(function()
		{
		    ...
		    $('#questionsFile').change(
		            function(){
		                if ($(this).val()) {
		                    $('#questionsUpload').attr('disabled',false);
		                    // or, as has been pointed out elsewhere:
		                    // $('input:submit').removeAttr('disabled'); 
		                } 		            
		    });
		    
		    $('#pqrsEntityFile').change(
		            function(){
		                if ($(this).val()) {
		                    $('#pqrsEntityUpload').attr('disabled',false);
		                    // or, as has been pointed out elsewhere:
		                    // $('input:submit').removeAttr('disabled'); 
		                } 		            
		    });
 ...
 <div id="page-wrapper">
    ...
    <ul>
        ...
        <!--adding link-->
        <li>
            <a href="${pageContext.request.contextPath}/app/admin/filesupload">File Upload</a> 
        </li>
        <!--<li>
            <a href="#" style="text-decoration: none;">Questions Upload</a>
					...
					<div class="row">
						<div class="12u">
 						...
 						<form:form modelAttribute="questionsFileUpload"
													...
													<c:if test="${not empty questionuploadsuccess}">
													<br/>
														<div class="successblock">
															<spring:message code="${questionuploadsuccess}"></spring:message>
														</div>
													</c:if>
													<c:if test="${not empty questionuploaderror}">
													<br/>
														<div class="successblock">
															<spring:message code="${questionuploaderror}"></spring:message>
														</div>
													</c:if>																									
																	...
																	<tr>
																		<td valign="top"><div class="form_input">
																				<button type="submit" class="btn_small btn_blue"
																					name="btnAction" value="Upload" id="questionsUpload" disabled>
																					<span>Upload</span>
																				</button>
																			</div></td>
																		<td valign="top"><div class="form_input">
					...
					<form:form modelAttribute="pqrsEntityFileUpload"
													...
													method="post" class="form_container left_label"
													enctype="multipart/form-data">
													<c:if test="${not empty entityuploadsuccess}">
													<br/>
														<div class="successblock">
															<spring:message code="${entityuploadsuccess}"></spring:message>
														</div>
													</c:if>
													<c:if test="${not empty entityuploaderror}">
													<br/>
														<div class="successblock">
															<spring:message code="${entityuploaderror}"></spring:message>
														</div>
													</c:if>		
													<form:errors path="*" cssClass="errorblock" element="div" />
													<br/>
															...
															<div class="form_grid_12">
																<table>
																	<tr>
																		<td valign="top"><div class="form_input">
																				<button type="submit" class="btn_small btn_blue"
																					name="btnAction" value="Upload" id="pqrsEntityUpload"disabled>
																					<span>Upload</span>
																				</button>
																			</div></td>
																		<td valign="top"><div class="form_input">
