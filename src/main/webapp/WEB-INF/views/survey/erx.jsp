							...
							<div id="banner">
								<div id="page-wrap">
									...
									<form:form modelAttribute="questionsList"
												action="${pageContext.request.contextPath}/app/addpqrsentityresponses/6"
									...
									<ul id='main-nav' class='tabs'>
										...
										<li id='2' class="training" tabindex="5" ><a   id="navigationLink" href="#" media='${pageContext.request.contextPath}/app/addpqrsentityresponses/2'
											title="click here to view question in Training Information">Training Information</a></li>
										...
										<li id='5' class="current" tabindex="7"><a href='#tab5'
													...
													<c:forEach var="question" items="${questionbank}"
														...
														<c:if test="${question.questionType.id==2}">
															...
															<li style="padding-left: 30px; padding-top: 20px;" tabindex="11">
																...
																<label id="number-nav">${counter1.index+1}.&nbsp;&nbsp;</label>
																	<label id="question-nav"
																		for="questionsList[${counter1.index}].firstAnswerList" title="${question.firstAnswerList[0]}" >${question.questionDescription}</label>
															...
															<li style="padding-left: 30px; padding-top: 20px;" tabindex="12">
																...
																<label id="number-nav">${counter1.index+1}.&nbsp;&nbsp;</label>
																	...
																	<div class="form_input"
																		...
																		<label
																			for="questionsList[${counter1.index}].secondAnswerList" title="Other box">Other:</label>
																		<textarea rows="3" cols="38" name="questionsList[${counter1.index}].secondAnswerList" class="questiontextarea" title="${question.secondAnswerList[0]}">${question.secondAnswerList[0]}</textarea>
																	<div style="padding-top:10px;">Note:&nbsp;&nbsp;Limit 4000 characters</div>
																	</div>
																</div>
															</li>
...
<div style="padding-top:10px;">Note:&nbsp;&nbsp;Hold down the control key while clicking to select multiple answers.</div>
																	...
																	<div class="form_input"
																		...
																		<label
																			for="questionsList[${counter1.index}].secondAnswerList" title="Other">Other:</label>
																		<textarea rows="3" cols="38" name="questionsList[${counter1.index}].secondAnswerList" class="questiontextarea" title="${question.secondAnswerList[0]}">${question.secondAnswerList[0]}</textarea>
																	<div style="padding-top:10px;">Note:&nbsp;&nbsp;Limit 4000 characters</div>
																	</div>
																</div>
...
<div style="padding-top:10px;">Note:&nbsp;&nbsp;Hold down the control key while clicking to select multiple answers.</div>
														...
														<li style="padding-left: 30px; padding-top: 20px;" tabindex="22">
																<div class="form_grid_12">
																<label id="number-nav">${counter1.index+1}.&nbsp;&nbsp;</label>
																	<label id="question-nav"
																		for="questionsList[${counter1.index}].firstAnswerList">${question.questionDescription}</label>
