							...
							<div id="banner">
								<div id="page-wrap">
									...
									<form:form modelAttribute="questionsList"
												action="${pageContext.request.contextPath}/app/addpqrsentityresponses/3"
												method="post" enctype="multipart/form-data"
												name="questionsForm" id="questionsForm">
									...
									<ul id='main-nav' class='tabs'>
										...
										<li id='2' class="current" tabindex="5" ><a href='#tab2'
																...
																<div class="form_grid_12">
																   <label id="number-nav">${counter1.index+1}.&nbsp;&nbsp;</label>
																	...
																	<div class="form_input"
																		...
																		<select
																			name="questionsList[${counter1.index}].firstAnswerList"
																			multiple="multiple" style="width:335px" title="Hold down the Ctrl key while clicking to select multiple answers." class="questionselectbox">
																			<c:forEach var="answer"
																				items="${question.answersArrayList}">
																				<option value="${answer }"
																					<c:forEach var="singleAnswer" items="${question.firstAnswerList }">
														...
														<c:if test="${question.questionType.id==8}">
															...
															<li style="padding-left: 30px; padding-top: 20px;" tabindex="16">
																<div class="form_grid_12">
																	...
																	<div style="padding-top:10px;">Note:&nbsp;&nbsp;Limit 4000 characters3</div>
																	</div>
																</div>
															</li>
...
<span>
																		<input type="radio" id="radiobuttonquestion"
																			name="questionsList[${counter1.index}].secondAnswerList"
																			value="Yes"
																			<c:if test="${question.secondAnswerList[0]=='Yes'}">checked="checked"</c:if>>
																		<label
																			for="questionsList[${counter1.index}].secondAnswerList" id="radiobuttonlabel">Yes</label>
																		<input type="radio" id="radiobuttonquestion"
																			name="questionsList[${counter1.index}].providedAnswerList"
																			value="No"
																			<c:if test="${question.secondAnswerList[0]=='No'}">checked="checked"</c:if>><label
																			for="questionsList[${counter1.index}].secondAnswerList" id="radiobuttonnolabel">No</label>
																			</span>
																	</div>
																</div>
															</li>
														...
														<li style="padding-left: 30px; padding-top: 20px;" tabindex="21">
																...
																<label id="number-nav">${counter1.index+1}.&nbsp;&nbsp;</label>
																	...
																	<div class="form_input"
																		...
																		<textarea rows="3" cols="38" name="questionsList[${counter1.index}].secondAnswerList" class="questiontextarea">${question.secondAnswerList[0]}</textarea>
																	<div style="padding-top:10px;">Note:&nbsp;&nbsp;Limit 4000 characters5</div>
																	</div>																	
																	<div class="form_input"
																		style="padding-left: 20px; padding-top: 20px;">
																	<div id="fileuploadoption">
