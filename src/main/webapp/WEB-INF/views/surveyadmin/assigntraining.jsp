						...
						<div id="breadcrumb">
							    <ul>
							        ...
							        <li>
							         ...
							         <li>
							            <a >Add Training Questions</a> <span> </span>
							        </li>							       
							    </ul>
							</div>
							<div id="banner">
								<div id="page-wrap">
									...
									<form:form modelAttribute="questionsList"
												action="${pageContext.request.contextPath}/app/admin/saveassignquestion/${surveyid}/1"
												method="post" enctype="multipart/form-data"
												name="assignTrainingForm">
									<form:errors path="*" cssClass="errorblock" element="div" />
									<ul id='main-nav' class='tabs'>
																			
										<li id='1' class="current"><a href='#tab2'>Training	Information</a></li>
