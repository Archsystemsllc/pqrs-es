$(function() {
	...
	$("#usersurveyForm").validate({
		alert("mobeena validation");
		rules: {
			otherbox: "required",
			lastname: "required",
			username: {
		...
		messages: {
			otherbox: "Please enter your firstname",
	...
	/*$('ul li').click(function(e) {
	   ...
	   if ($(this).val() == 2)
		   ...
		   $(this).addClass('current_page_item');
		    ...
		    ({  
		     type : "Get",   
		     url : "${pageContext.request.contextPath}/app/questions"   
		    });  
		   }
	...
	/* select the question select box in create question page*/
	$('#questionTypeId').click(function () {
		 ...
		 if ($(this).val() == 1 || $(this).val() == 6 
			    ...
			    else $('.optionsbutton').hide(); // hide div if value is not "custom"
			    ...
			    else $('.descriptivetext1').hide(); // hide div if value is not "custom"
				
				if ($(this).val() == 4 || $(this).val() == 5) {
					$('.yesorno1').show();
			    }
			    else $('.yesorno1').hide(); // hide div if value is not "custom"
		
	});
	
	
	/*--- add option button table in create question page */
    ...
    /*Colapsible Widget*/
    $(".collapsible_widget").collapse({ head : ".c_widget_top",
